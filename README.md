...
| คำสั่ง | การทำงาน |
| :--- | :--- |
| `/parking` | จอดรถที่กำลังขับอยู่เพื่อบันทึกพิกัดและล็อกรถ |
| `/unparking` | ปลดล็อกการจอดของรถที่อยู่ตรงหน้าเพื่อนำออกไปขับ |
| `/myvehicles` | เปิดเมนูดูรายการรถที่จอดอยู่ทั้งหมด พร้อมระบบนำทาง |
